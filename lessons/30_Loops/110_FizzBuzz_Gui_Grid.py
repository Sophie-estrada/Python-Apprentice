...
for row in range(10):
    for col in range(10):
        if number % 15 == 0:
           Text(app, text='🐍 snake', grid=[col, row], color='red')
        elif number % 3 == 0:
           Text(app, text='🍄 mushroom', grid=[col, row], color='yellow' )
        elif number % 5 == 0:
           Text(app, text='🦡 badger', grid=[col, row], color='black' )
        else:
            Text(app,text='no', grid=[col, row], color='white')
        number+=1
